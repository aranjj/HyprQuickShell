                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Column {
                                ...
                                Text {
                                    text: "Auto-cycles Dawn, Day, Dusk, Night"
                                    color: root.theme.textMuted
                                    font.pixelSize: 10
                                    font.family: root.font
                                }
                            ...
                            Rectangle {
                                ...
                                height: 22
                                radius: 11
                                color: Services.WallpaperService.dynamicMode ? "#30d158" : Qt.rgba(1, 1, 1, 0.18)
                                Behavior on color { ColorAnimation { duration: 150 } }
                                ...
                                Rectangle {
                                    ...
                                    radius: 9
                                    anchors.verticalCenter: parent.verticalCenter
                                    x: Services.WallpaperService.dynamicMode ? parent.width - 20 : 2
                                    color: "#ffffff"
                                    Behavior on x { NumberAnimation { duration: 150; easing.type: Easing.OutCubic } }
                                }
                                ...
                                MouseArea {
                                    ...
                                    cursorShape: Qt.PointingHandCursor
                                    onClicked: {
                                        Services.WallpaperService.dynamicMode = !Services.WallpaperService.dynamicMode;
                                        if (Services.WallpaperService.dynamicMode) {
                                            Services.WallpaperService.updateDynamicWallpaper();
                                        }
                                    }
                                }
                            }
